...
#include <ThrowParams.h>
 ...
 ThrowParams::ThrowParams(TVectorD &parms, TMatrixDSym &covm)
 {  
 ...
 void ThrowParams::ThrowSet(std::vector<double> &parms)
 {
...
void ThrowParams::CheloskyDecomp(TMatrixD &chel_mat){
