...
#./bin/$Type_mode -c1 input_$Dect1.card -c2 input_$Dect2.card -o $outdir/$Type_mode/$Dect1/${Type_mode}_sin23_0.50_${first}_run_gr_100_2hk_reactor.root -co osc_param.card -cs syst_param_total.card -p1 0.45 -n1 ssqth23 -n2 dm32 -s1 ${first} 
